...
/**
 * OSS FileSystem provide implementations of all of the functionality of FileSystem.
 * This collection of tests is used to verify the contract of the abstract FileSystem interface.
 */
public class TestOSSFileSystemContract extends FileSystemContractBaseTest {
  protected static final Logger LOG = LoggerFactory.getLogger(TestOSSFileSystemContract.class);
  ...
  public void setUp() throws Exception {
    ...
    fs.initialize(new URI(conf.getTrimmed(TEST_FS_OSS_NAME)), conf);
  ...
  public void testRenameFileAsExistingFile() throws Exception {
    ...
    createFile(dst);
    // oss doesn't support rename option
